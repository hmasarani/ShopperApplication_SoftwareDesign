...
public class AdminAddItemInterface extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminAddItemInterface window = new AdminAddItemInterface();
		...
		addItemBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!itemName.equals("") || !description.equals("") || !price.equals("") || !size.equals("")
					...
					JOptionPane.showMessageDialog(null, "Invalid/Missing Inputs. Please Try again.", "Error Message",
