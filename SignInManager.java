...
public class SignInManager extends JFrame {
	...
	public SignInManager() {
		...
		setTitle("Welcome to SmartShopper App, MANAGER!");
		...
		Label label_1 = new Label("Sign In as Manager");
				...
				if (username.equals("") == false || password.equals("") == false) {
					...
					try {
						fileScan = new Scanner(
								new File("C:\\Users\\hassanax\\eclipse-workspace\\Project\\src\\managerLogins.txt"));
						boolean found = false;
						while (fileScan.hasNextLine()) {
							...
							if (thisUsername.equals(username) || (thisPassword.equals(password))) {
								...
								dispose();
								ManagerInterface home = new ManagerInterface();
								home.main(null);
