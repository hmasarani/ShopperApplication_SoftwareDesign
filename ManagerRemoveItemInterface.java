...
public class ManagerRemoveItemInterface extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ManagerRemoveItemInterface window = new ManagerRemoveItemInterface();
	...
	public ManagerRemoveItemInterface() {
		initialize();
	}
